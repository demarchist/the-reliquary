...
title: "The Reaver"
category: "Things"
aliases: ["Stabby", "Sacrificial Dagger", "Cursed Dagger"]
firstAppearance: "chapter-01-session-07"
description: "A cursed rusted shortsword of Orcus that psychically attacked its wielder, destroyed in a moonlit cleansing ritual that gave birth to Eclipse."
status: "Destroyed"
---
...
The cursed weapon required specific gemstones, a full moon, hallowed ground, and an oath to Eilistraee to destroy. Patches gathered the components over months before performing the ritual atop the white stone altar in the ruined Temple of Helm in Sundabar. She smashed each gemstone upon the blade with an enchanted mallet, reciting the oath, and when the last hag's tooth shattered, the Reaver shattered with it — unleashing an explosion of mist and frost that coated the cathedral in white.
